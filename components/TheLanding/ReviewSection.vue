<template>
  <div class="flex justify-center items-center lg:flex-row flex-col">
    ...
    <div class="flex flex-col gap-6 p-5 lg:w-[calc(100%-350px)] h-full">
      <i class="isax isax-quote-up5 text-3xl text-Gray-b5 opacity-50"></i>
      ...
      <div>
        <p class="lg:text-lg text-base text-Gray-b5">Shahriar Johari</p>
        <p class="lg:text-lg text-base text-Gray-b4">CEO at HubSmartup</p>
      </div>
    </div>
  </div>
</template>
