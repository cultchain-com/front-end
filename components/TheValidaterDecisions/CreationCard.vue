      ...
      <div class="flex justify-between items-center mt-4">
        <div class="flex flex-col gap-2 items-center">
          ...
          <p class="md:text-base text-sm text-Gray-b5">
            {{ state.proposalDetail.targetAmount / Math.pow(10, 18) }} ETH
          </p>
        </div>
        <div class="flex flex-col gap-2 items-center">
          <p class="md:text-sm text-xs text-Gray-b3">Collected Amount</p>
          <p class="md:text-base text-sm text-Gray-b5">
            {{ state.proposalDetail.collectedAmount / Math.pow(10, 18) }} ETH
          </p>
        </div>
      </div>
    </section>
