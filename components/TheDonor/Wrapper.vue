  ...
  <div class="flex flex-col gap-8 py-20">
    ...
    <div class="flex flex-col gap-6 bg-Gray-b2 p-5 rounded-xl mb-20 shadow-xl">
      <section class="flex gap-3 items-center lg:flex-row flex-col">
        <p
          class="text-Gray-b5 lg:w-[calc(100%-300px)] leading-10 lg:text-[16px] text-sm"
        >
      ...
      <section class="flex gap-3 justify-center lg:flex-row flex-col">
        <NuxtLink
          to="/events"
          class="text-Gray-b5 lg:w-fit w-full justify-center text-sm font-semibold flex items-center gap-2 rounded-xl border-Primary border-2 px-5 py-3 hover:bg-Primary"
        >
          <Icon name="event" />
          Visit Events
        </NuxtLink>
        <button
          class="text-Gray-b5 lg:w-fit w-full justify-center text-sm font-semibold flex items-center gap-2 rounded-xl border-Primary border-opacity-80 hover:border-opacity-100 bg-Primary bg-opacity-80 hover:bg-opacity-100 border-2 px-5 py-3"
        >
          <Icon name="token" />
          But Token
        </button>
